...
export default function BlogClient({ posts }: BlogClientProps) {
  // Merge database posts with static posts. DB posts come first.
  ...
  return (
    <div className="pt-32 pb-0 bg-white font-sans overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 mb-24">
              ...
              >
                ...
                >
                  ...
                  <div className="p-5 md:p-6 flex flex-col flex-grow">
                    ...
                    {/* Excerpt Summary */}
                    <p className="text-gray-500 text-[12px] font-semibold leading-relaxed mb-3 line-clamp-2">
                      {excerpt}
                    </p>
        ...
        {/* High-Fidelity Circular Pagination Bar */}
        <div className="flex items-center justify-center gap-2 mt-16">
          <button className="w-8 h-8 rounded-lg bg-[#1a8b4c] text-white flex items-center justify-center text-xs font-black shadow-sm">
            1
          </button>
          <button className="w-8 h-8 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 flex items-center justify-center text-xs font-bold transition-all">
            2
          </button>
          <button className="w-8 h-8 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 flex items-center justify-center text-xs font-bold transition-all">
            3
          ...
          <button className="px-3.5 h-8 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 flex items-center justify-center text-xs font-bold transition-all gap-1">
